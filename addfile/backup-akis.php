<?php 
  $para = array(
    ...
    'db_uname' => 'root',  //user
    'db_password' => '', //pass
    'db_to_backup' => 'db_datasiswa', //database name
    'db_backup_path' => '/', //where to backup
    'db_exclude_tables' => array('tb_admin','tb_barang','tb_id','tb_invoice','tb_lab','tb_ordertmp','tb_pemeriksaan','tb_profil','tb_siswa','tb_test') //tables to exclude
  );
